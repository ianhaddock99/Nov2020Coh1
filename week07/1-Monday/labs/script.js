...
async function sendApiRequest(value){
    let APP_ID = "0c2c7560"
    let APP_KEY = "23805fa10b25c34a723cd85fbee9504d"
    let response = await fetch(`https://api.edamam.com/search?app_id=${APP_ID}&app_key=${APP_KEY}&q=${value}`);
  ...
  for (let i = 0;i < 5; i++) {
    ...
    document.querySelector("#content").innerHTML += ` 
            ...
            <div class="card-body">
              ...
              <p class="card-text">Health Labels: ${data.hits[i].recipe.healthLabels}</p>
